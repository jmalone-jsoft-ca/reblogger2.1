...
<TABLE align=right width=100%  bgcolor=000045>
...
<TABLE align=right width=100% height=100% bgcolor=000000>
   <TR><TD valign=bottom width=100% align=right><FONT size=5><I>Reblogger</I><br><font size=1>Version: Better Than the Last One</TD><TD valign=top align=right><IMG src=../../LogoR.gif></TD></TR>
   <TR>
