...
#J-Soft Reblogger version: 2.1r2
...
<HTML>
   ...
   <meta name="keywords" content="weblog,weblogs,html,template,Blogger,BlogStudio, Diary-x, Diaryland, Big Blog Tool, Pitas, Bloxsom, Thingamablog, Radio Userland,comment system,blog,comment,system,weblog,web log,comments,commenting,web" />
   <STYLE type=text/css>
...
<HTML>
   ...
   <STYLE type=text/css name=norm>
	...
	A:link {COLOR: #ffffff; TEXT-DECORATION: underline;}
        A:hover {COLOR: #d45700; TEXT-DECORATION: none;}
	A:unknown {COLOR: #ffffff; TEXT-DECORATION: underline;}
	div.ads {border-style:solid;border-color:#fff;border-width:1px;}
   </STYLE>
   <script type="text/javascript"><!--
				google_ad_client = "pub-3556826062759189";
				google_ad_width = 120;
				google_ad_height = 240;
				google_ad_format = "120x240_as";
				google_ad_type = "text_image";
				google_ad_channel ="";
			//	google_color_border = "435577";
				google_color_border = "ffffff";
				google_color_bg = "000076";
				google_color_link = "ffffff";
				google_color_url = "ffffff";
				google_color_text = "FFFFFF";
				google_page_url = "http://jsoft.ca/reblogger/index.php";
    //--></script>	
   </HEAD>
   ...
   <TR>
	 ...
	 <table align=center width=90%>
		...
		<td valign=top>
			...
			<tr>
			   <td><div class="ads" style="width:120px;"><script type="text/javascript" src="http://pagead2.googlesyndication.com/pagead/show_ads.js"> </script></div></td>
			   <td align="left" valign="top">
				<font size="2"><p>There will never be ads arbitrarily placed in your comment window. Your comment window is yours to do with as you please.</p><p>You can support Reblogger by making a donation of any amount. If you like reblogger, please consider making a donation. To do so, click on the button below.</p></font>
...

...

-----END PKCS7-----
">
</form></center>
			   </td>
